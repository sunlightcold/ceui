...
export class BasicComponent implements OnInit, AfterViewInit {
  imgList = [
    ...
    { src: `https://img1.baidu.com/it/u=3041604093,3909442121&fm=26&fmt=auto&gp=0.jpg1` },
    { src: `https://img2.baidu.com/it/u=1325995315,4158780794&fm=26&fmt=auto&gp=0.jpg1` },
